...
<div class="demo-nav padding-big-top padding-big-bottom fixed" id="nav">
  ...
  <div class="container">
    <div class="line-middle list">
      ...
      <!-- 前端框架循环开始 -->
      <?php if(is_array($content1)): foreach($content1 as $key=>$qd): ?><div class="xl12 xs6 xm3 xb3 margin-bottom">
          <div class="media">
      ...
      <!-- 循环结束 -->
      <br />
      <p class="text-right"><a href="<?php echo U('fream/qianduan');?>">更多</a></p>
    </div>
  </div>
  <!-- 后端框架 -->
  <div class="container">
    <div class="line-middle list">
      <h3 class="padding-bottom border-bottom margin-bottom padding icon-caret-right"> PHP框架</h3>
      <!-- 后端框架循环开始 -->
      <?php if(is_array($content2)): foreach($content2 as $key=>$hd): ?><div class="xl12 xs6 xm3 xb3 margin-bottom">
          <div class="media border">
            <a class="img clearfix" href="<?php echo ($hd["link"]); ?>" target="_blank">
              <img src="<?php echo ($hd["image"]); ?>" class="img-responsive padding-small border bg-white" alt="" />
            </a>
            <div class="media-body padding-top border-bottom"> <strong class="text-center"><?php echo ($hd["name"]); ?></strong>
              <a href="<?php echo ($hd["link"]); ?>" target="_blank" class="button button-little bg-main margin-small">访问</a>
            </div>
          </div>
        </div><?php endforeach; endif; ?>
      <!-- 循环结束 -->
      <br />
       <p class="text-right"><a href="<?php echo U('fream/php');?>">更多</a></p>
    </div>
  </div>
  <!-- 其他 -->
  <div class="container">
    <div class="line-middle list">
      <h3 class="padding-bottom border-bottom margin-bottom padding icon-caret-right"> 其他精选</h3>
      <!-- 其他循环开始 -->
      <?php if(is_array($content3)): foreach($content3 as $key=>$qt): ?><div class="xl12 xs6 xm3 xb3 margin-bottom">
          <div class="media">
            <a class="img clearfix" href="<?php echo ($qt["link"]); ?>" target="_blank">
              <img src="<?php echo ($qt["image"]); ?>" class="img-responsive padding-small bg border radius-big" alt="" />
            </a>
            <div class="media-body padding-top border-bottom">
              <strong class="text-center"><?php echo ($qt["name"]); ?></strong>
              <a href="<?php echo ($qt["link"]); ?>" target="_blank" class="button button-little bg-main margin-small">访问</a>
            </div>
          </div>
        </div><?php endforeach; endif; ?>
            <br />
       <p class="text-right"><a href="<?php echo U('fream/other');?>">更多</a></p>
      <!-- 循环结束 --> </div>
  </div>
