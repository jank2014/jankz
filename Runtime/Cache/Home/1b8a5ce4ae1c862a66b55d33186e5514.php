		...
		<div class="line-big">
			...
			<div class="xl2 xm9">
				<div class="banner">
					<div class="carousel">
						<div class="item">
							<a href="<?php echo U('Home/Index/qybase/id/7.html');?>">
							<img src="/jankz/Public/Home/images/qianyan/dh/semantic.jpg" width="100%"  class="responsive" />
							</a>
						</div>
						<div class="item">
							<a href="<?php echo U('Home/Index/qybase/id/22.html');?>">
							<img src="/jankz/Public/Home/images/qianyan/dh/centos.jpg" width="100%"  class="responsive" />
							</a>
						</div>
						<div class="item">
							<a href="<?php echo U('Home/Index/qybase/id/15.html');?>">
								<img src="/jankz/Public/Home/images/qianyan/dh/sublime.jpg" width="100%"  class="responsive" />
							</a>
						</div>
						<div class="item">
							<a href="<?php echo U('Home/Index/qybase/id/16.html');?>">
								<img src="/jankz/Public/Home/images/qianyan/dh/webstorm.jpg" width="100%"  class="responsive" />
							</a>
						</div>
					</div>
				</div>
				<div class="line-big">
					<div class="xs6">
						...
						<!-- <img src="holder.js/388x270" width="100%" />
						-->
						<ul class="list-unstyle height-big padding-top">
						<!-- 前端框架 -->
							<?php if(is_array($qianyan1)): foreach($qianyan1 as $key=>$q1): ?><li>
								<span class="badge bg-red">新闻</span>
								<a href="<?php echo U("Index/qybase",array('id'=>$q1["id"]));?>"><?php echo ($q1["title"]); ?></a>
					...
					<div class="xs6">
						...
						<ul class="list-unstyle height-big padding-top">
						<!-- php框架 -->
							<?php if(is_array($qianyan2)): foreach($qianyan2 as $key=>$q2): ?><li>
								<span class="badge bg-yellow">新闻</span>
								<a href="<?php echo U("Index/qybase",array('id'=>$q2["id"]));?>"><?php echo ($q2["title"]); ?></a>
							</li><?php endforeach; endif; ?>
						</ul>
					</div>
					<div class="xs6">
						<img src="/jankz/Public/Home/images/qianyan/zy/elementary.jpg" width="100%" class="img-responsive padding-big" />
						<ul class="list-unstyle height-big padding-top">
													<!-- linux -->
							<?php if(is_array($qianyan3)): foreach($qianyan3 as $key=>$q3): ?><li>
								<span class="badge bg-blue">新闻</span>
								<a href="<?php echo U("Index/qybase",array('id'=>$q3['id']));?>"><?php echo ($q3["title"]); ?></a>
							</li><?php endforeach; endif; ?>
						</ul>
					</div>
					<div class="xs6">
						...
						<ul class="list-unstyle height-big padding-top">
						<!-- 工具 -->
							<?php if(is_array($qianyan4)): foreach($qianyan4 as $key=>$q4): ?><li>
								<span class="badge bg-main">新闻</span>
								<a href="<?php echo U("Index/qybase",array('id'=>$q4['id']));?>"><?php echo ($q4["title"]); ?></a>
							</li><?php endforeach; endif; ?>
						</ul>
					</div>
				</div>
